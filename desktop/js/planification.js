  ...
  document.getElementById('tab_Paramètres').addEventListener('click', function(event) {
    ...
    if (_target = event.target.closest('.btn_numeric')) {
      ...
      if (_target.classList.contains('up') && parseInt(el.value) < parseInt(el.max)) {
        ...
        console.log(_target.closest('.cmd').getAttribute('data-cmd_id'));
        jeedom.cmd.execute({
  ...
  function saveEqLogic(_eqLogic) {
    ...
    const configuration_eqLogic=_eqLogic.configuration
    configuration_eqLogic.Chemin_image = document.querySelector('#tab_eqlogic .eqLogicAttr[data-l2key=Chemin_image]').value;
    configuration_eqLogic.Mode_id = document.querySelector('#tab_eqlogic .eqLogicAttr[data-l2key=Mode_id]').value;
    configuration_eqLogic.Type_équipement = document.querySelector('#tab_eqlogic .eqLogicAttr[data-l2key=Type_équipement]').value;
    configuration_eqLogic.Duree_mode_manuel_par_defaut = document.querySelector('#tab_eqlogic .eqLogicAttr[data-l2key=Duree_mode_manuel_par_defaut]').value;
    ...
    if (type_équipement === "Volet") {
      ...
      configuration_eqLogic.Alias_Ouvert = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Alias_Ouvert]`).value;
      configuration_eqLogic.Alias_Ferme = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Alias_Ferme]`).value;
      configuration_eqLogic.Alias_My = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Alias_My]`).value;

      let type_fenêtre = "fenêtre";
      document.querySelectorAll(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=type_fenêtre]`).forEach(_el => {
        if (_el.checked) {
          type_fenêtre = _el.id;
        }
      });
      configuration_eqLogic.Type_fenêtre = type_fenêtre;

      let sens_ouverture = "gauche";
      document.querySelectorAll(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=sens_ouveture_fenêtre]`).forEach(_el => {
        if (_el.value == 1) {
          sens_ouverture = _el.id;
        }
      });
      configuration_eqLogic.Sens_ouverture = sens_ouverture;

      configuration_eqLogic.Etat_fenêtre_gauche_id = "";
      configuration_eqLogic.Niveau_batterie_gauche_id = "";
      configuration_eqLogic.Etat_fenêtre_droite_id = "";
      configuration_eqLogic.Niveau_batterie_droite_id = "";

      if (sens_ouverture === "droite") {
        configuration_eqLogic.Etat_fenêtre_droite_id = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Etat_fenêtre_droite_id]`).value;
        configuration_eqLogic.Niveau_batterie_droite_id = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Niveau_batterie_droite_id]`).value;
      }

      if (sens_ouverture === "gauche") {
      configuration_eqLogic.Etat_fenêtre_gauche_id = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Etat_fenêtre_gauche_id]`).value;
        configuration_eqLogic.Niveau_batterie_gauche_id = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Niveau_batterie_gauche_id]`).value;
      }
    ...
    if (type_équipement === 'Prise') {
      ...
      configuration_eqLogic.Alias_Off = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Alias_Off]`).value;
    }
    if (type_équipement === 'Chauffage') {
      configuration_eqLogic.etat_id = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=etat_id]`).value;
      configuration_eqLogic.Alias_Confort = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Alias_Confort]`).value;
      configuration_eqLogic.Alias_Eco = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Alias_Eco]`).value;
      configuration_eqLogic.Alias_Hg = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Alias_Hg]`).value;
      configuration_eqLogic.Alias_Arret = document.querySelector(`#tab_eqlogic .${configuration_eqLogic.Type_équipement} .eqLogicAttr[data-l2key=Alias_Arret]`).value;
    }
    if (type_équipement === 'Autre') {
    }
    _eqLogic.configuration = configuration_eqLogic;
    let Json = '';
    let Json1 = []
    let erreur = false;
    let numéro = 0;
